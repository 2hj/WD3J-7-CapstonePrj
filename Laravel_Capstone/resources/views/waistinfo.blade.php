      ...
      {{--  <div class="col-sm-6">
        ...
        <div class="col-sm-3" style="margin-top: 20px;">
          <div class="card border-success mb-3" style="max-width: 18rem;">
            <div class="card-header bg-transparent border-success">test 님의 척추 건강</div>
            <div class="card-body text-success">
              <h5 class="card-title"></h5>
              <img src="/img/user.png" class="card-img-top" alt="..." style="width: 130px; height: auto; margin: 0 auto;">
            </div>
            <div class="card-footer bg-transparent border-success">
              <button type="button" class="btn btn-primary" id="redirect-stats" onclick="location.href='/mypage' ">내 자세이력 보러가기</button>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <h2 style="margin: 20px 0 10px 0;">test 님에게 추천하는 스트레칭</h2>
        </div>
