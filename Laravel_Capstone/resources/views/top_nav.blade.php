    ...
    <div class="header">
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #04D976;">
        <a class="navbar-brand" href="/">
          <img src="/img/logo_white.png" width="200" height="auto" alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto" style="font-weight: 700;">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="/products">제품구매</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/stats">통계</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/waistinfo">허리건강/스트레칭정보</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="/challenges">챌린지</a>
            </li>
