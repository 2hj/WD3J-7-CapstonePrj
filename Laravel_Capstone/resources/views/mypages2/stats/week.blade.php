...
<div class="container">
    <div class="row">
        <div class="col-md-12 mypage-title">
          <h4 class="mypage-body-title" id="this-week"></h4>
        </div>
        ...
        <div class="col-3 top-div-box-3">
            <div class="stat-card">
                <div class="card-title">今週の悪い姿勢</div>
                <div class="card-body">
        ...
        <div class="col-3 top-div-box-3">
            <div class="stat-card">
                <div class="card-title week-report"><p id="week-report"></p></div>
                <div class="card-body">
                  <h5 style="color: #696969;">正しい姿勢チャレンジに参加しました。</h5>
                  <h6>達成率 : 37%</h6>
                  <h5 style="color: #696969; padding-top:10px;">ストレッチゲーム：トップスコア</h5>
                  <h6>850点</h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 main-div-box stat-main-linechart">
            {{--{!! json_encode($data) !!}--}}
            <?php $msg = $data; ?>
            <h4 class="mypage-body-title" >今週の姿勢変化</h4>
        ...
        <div class="col-6 main-div-box" style="margin-top:30px;">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">今週はどんな姿勢で座ったか？</h5>
        ...
        <div class="col-9 main-div-box" style="margin-top:30px;">
            <h4 class="mypage-body-title" >曜日による姿勢変化</h4>
...
<script type="text/javascript">
  var today = new Date();
  var this_week_first_day = today;
  var this_week_last_day = today;
  ...
  var no_week;
  var if_week = today_week - dd%7;
  console.log('if_week = '+if_week);

  if(if_week < 0) no_week = Math.floor(dd/7 + 2);
  else if(if_week > 0) no_week = Math.floor(dd/7 + 1);
  console.log('no_week = '+no_week);


  this_week_first_day.setDate(dd - today_week);
  console.log('this_week_first_day : '+this_week_first_day);
  var twfd_string = this_week_first_day.getFullYear()+'-'+(this_week_first_day.getMonth()+1)+'-'+this_week_first_day.getDate();

  this_week_last_day.setDate(dd + (6-today_week) );
  var twld_string = this_week_last_day.getFullYear()+'-'+(this_week_last_day.getMonth()+1)+'-'+this_week_last_day.getDate();

  var this_week = '[ '+mm+'月 '+no_week+'週目 ] : ' + twfd_string + ' ~ ' + twld_string;

  $('#this-week').text(this_week);

  var week_report = mm+'月 '+no_week+'週目の姿勢レポート';
  $('#week-report').text(week_report);
